...
import { Layout, Grid, Drawer, Modal, Form, Input, Button, message } from "antd";
  ...
  const handleSaveProfile = async (values: any) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setUserProfile((prev: any) => prev ? { ...prev, name: updatedUser.name } : null);
            ...
            <div className={styles.sectionHeader} style={{ padding: "0 40px" }}>
              <div className={styles.headerTitleWrapper}>
                <h1 className={styles.headerTitle} style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                  ...
                  <Button
                    type="text"
                    icon={<EditOutlined style={{ color: "#0071f9" }} />}
        ...
        >
          ...
          <Form.Item style={{ marginBottom: 0, textAlign: "right", marginTop: 24 }}>
            ...
            <Button
              ...
              size="large"
              style={{ backgroundColor: "#0071f9", borderColor: "#0071f9" }}
            >
              Lưu thay đổi
            </Button>
          </Form.Item>
